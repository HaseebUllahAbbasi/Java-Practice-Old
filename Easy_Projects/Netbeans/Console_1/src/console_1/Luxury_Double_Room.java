    ...
    public void check_out() throws SQLException
    {
        ...
        if(room_list.contains(index))
        {
            ...
            room_list.remove(new Integer(index));
                ...
                Statement statement;
                statement = connection.createStatement();
                statement.executeUpdate("UPDATE [lux_double] SET name="+null+", contact= "+null+",bill="+0+" where number= "+index+" ");
    ...
    public void order_fod() throws SQLException  
    {
        ...
        if(room_list.contains(index))
        {
            ...
            if(choice==1)
                ...
                Statement statement;
                statement = connection.createStatement();
                statement.executeUpdate("UPDATE [lux_double] SET bill=" +list[index].bill+" where number= "+index+" ");
                System.out.println("data has been entered");
