...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        initComponents();
        this.setLocationRelativeTo(null); // Centers the form upon opening
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4);
        jLabel4.setBounds(40, 100, 80, 30);
        ...
        jTextFieldAdminUsername.setBounds(140, 40, 180, 30);

        jPasswordFieldAdmin.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jPanel2.add(jPasswordFieldAdmin);
        jPasswordFieldAdmin.setBounds(140, 100, 180, 30);

        AdminSignUpButton.setBackground(new java.awt.Color(255, 255, 0));
        ...
        AdminSignUpButton.setBounds(140, 150, 80, 40);

        AdminLoginButton.setBackground(new java.awt.Color(51, 51, 255));
        ...
        AdminLoginButton.setBounds(240, 150, 80, 40);
    ...
    private void AdminSignUpButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AdminSignUpButtonMouseClicked
        AdminRegistrationForm arf = new AdminRegistrationForm();
        arf.setVisible(true);
        arf.pack();
    ...
    private void AdminLoginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AdminLoginButtonMouseClicked
        ...
        String password = jPasswordFieldAdmin.getText();
        
        
        if (username.equals("Rumi") && password.equals("7262")){
            PatientDataEntryForm patientdataentryform = new PatientDataEntryForm();
            patientdataentryform.setVisible(true);
            patientdataentryform.pack();
            patientdataentryform.setLocationRelativeTo(null);
            patientdataentryform.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            this.dispose();
        }
        else {
