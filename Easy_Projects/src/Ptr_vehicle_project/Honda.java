public class Honda extends Bike
{
    ...
    Honda(int year,String registration_number,int price,String Model)
    {
    ...
    Honda(int year,String registration_number,int price,String Model,int distance_covered,int petrol)
    {
