public class Moto_GP_Bike extends Bike
{
    String Model;
    boolean status_grarge;
    boolean status_friend;

    Moto_GP_Bike(int year,String registration_number,int price,String Model)
    {
    ...
    Moto_GP_Bike(int year,String registration_number,int price,String Model,int distance_covered,int petrol)
    {
