public class Cultus extends Car
{
    String Model;
    boolean status_grarge;
    boolean status_friend;

    Cultus(int year,String registration_number,int price,String Model)
    {
    ...
    Cultus(int year,String registration_number,int price,String Model,int distance_covered,int petrol)
    {
    ...
    {
        // conditions to fill petrol and check whether the vehicle is present
