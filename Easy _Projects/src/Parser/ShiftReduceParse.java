/*
Parser Problem in compiler construction 
*/
...
public class ShiftReduceParse
{
    ...
    private void parse()
    {
        ...
        for (String lex: exp)
        {
            ...
            {
                System.out.println("Next Lexeme:" +lex);
                if((stack_top>0)&&((lex.equals(")")&&get_array_top().equals("("))||(lex.equals("}")&&get_array_top().equals("{"))||(lex.equals("]")&&get_array_top().equals("["))))
                {
                    pop();
                    operator = true;
                }
